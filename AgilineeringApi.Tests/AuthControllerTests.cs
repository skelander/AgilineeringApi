...
public class AuthControllerTests : IClassFixture<AgilineeringFactory>
{
    private readonly HttpClient _client;

    public AuthControllerTests(AgilineeringFactory factory)
    {
...
public class AuthLockoutTests : IClassFixture<AgilineeringFactory>
{
    private readonly HttpClient _client;

    public AuthLockoutTests(AgilineeringFactory factory)
    {
        _client = factory.CreateClient();
    }
...
public class AuthResetTests : IClassFixture<AgilineeringFactory>
{
    private readonly HttpClient _client;

    public AuthResetTests(AgilineeringFactory factory)
    {
        _client = factory.CreateClient();
    }
